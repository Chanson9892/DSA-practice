...
var lastStoneWeight = function(stones) {
    ...
    stones.splice(stones.indexOf(heavy1), 1)  //removes biggest stone

    let heavy2 = Math.max(...stones)
    stones.splice(stones.indexOf(heavy2), 1) // removes 2nd biggest stone

    if (heavy1 > heavy2) { // adds the new crushed stone
